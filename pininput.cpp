...
void PinInput::LoadSettings()
{
   ...
   m_joyroomrecenter = LoadValueIntWithDefault("Player"s, "JoyRoomRecenterKey"s, m_joyroomrecenter);
   m_joytablerecenter = LoadValueIntWithDefault("Player"s, "JoyTableRecenterKey"s, m_joytablerecenter);
   m_joytableup = LoadValueIntWithDefault("Player"s, "JoyTableUpKey"s, m_joytableup);
   m_joytabledown = LoadValueIntWithDefault("Player"s, "JoyTableDownKey"s, m_joytabledown);
